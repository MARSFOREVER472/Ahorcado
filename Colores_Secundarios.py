...
def reach_random_word(): # DEFINIMOS PALABRAS ALEATORIAS.
    words = ["naranja", "verde", "violeta", "green", "orange", "purple"] # MEDIANTE UN DICCIONARIO DE PALABRAS, SE DEFINEN MANUALMENTE AL MOMENTO DE DELETREAR CUALQUIER PALABRA AL AZAR.
