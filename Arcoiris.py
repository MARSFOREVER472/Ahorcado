...
def reach_random_word(): # DEFINIMOS PALABRAS ALEATORIAS.
    words = ["rojo", "naranja", "amarillo", "verde", "celeste", "azul", "violeta"] # MEDIANTE UN DICCIONARIO DE PALABRAS, SE DEFINEN MANUALMENTE AL MOMENTO DE DELETREAR CUALQUIER PALABRA AL AZAR.
