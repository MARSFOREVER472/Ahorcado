...
def reach_random_word(): # DEFINIMOS PALABRAS ALEATORIAS.
    words = ["lunes", "martes", "miercoles", "jueves", "viernes", "sabado", "domingo"] # MEDIANTE UN DICCIONARIO DE PALABRAS, SE DEFINEN MANUALMENTE AL MOMENTO DE DELETREAR CUALQUIER PALABRA AL AZAR.
